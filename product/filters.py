...
class ProductsFilter(django_filters.FilterSet):
    ...
    maxPrice = django_filters.filters.NumberFilter(field_name = "price" or  10000000 ,lookup_expr = 'lte')
    class Meta:
        model = Product
        #fields = ['catogry','brand']
        fields = ('catogry','brand','keyword','minPrice','maxPrice')